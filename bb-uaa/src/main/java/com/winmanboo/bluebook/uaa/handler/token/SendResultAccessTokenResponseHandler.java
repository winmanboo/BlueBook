package com.winmanboo.bluebook.uaa.handler.token;

import com.winmanboo.bluebook.constants.OAuth2Constant;
import com.winmanboo.bluebook.entity.OAuth2Token;
...
public class SendResultAccessTokenResponseHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        // get token from db
        com.winmanboo.bluebook.uaa.entity.OAuth2Token tokenInfo = oAuth2TokenService.getInfoByAccessToken(accessToken);
